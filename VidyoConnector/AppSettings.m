...
@synthesize host, token, displayName, resourceId, enableDebug, cameraPrivacy, microphonePrivacy, speakerPrivacy, experimentalOptions, hideConfig, autoJoin, allowReconnect, returnURL, vidyoCloudJoin, portal, roomKey, roomPin, enableAutoReconnect, disableVideoOnLowBw;
...
-(void) extractDefaultParameters {
    ...
    enableAutoReconnect = [[standardUserDefaults stringForKey:@"enableAutoReconnect"] isEqualToString:@"1"];
    disableVideoOnLowBw = [[standardUserDefaults stringForKey:@"disableVideoOnLowBw"] isEqualToString:@"1"];
...
-(void) extractURLParameters:(NSMutableDictionary *)urlParameters {
    ...
    enableAutoReconnect = [[urlParameters objectForKey:@"enableAutoReconnect"] isEqualToString:@"1"];
    disableVideoOnLowBw = [[urlParameters objectForKey:@"disableVideoOnLowBw"] isEqualToString:@"1"];
