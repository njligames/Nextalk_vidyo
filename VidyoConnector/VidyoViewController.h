...
@interface VidyoViewController : UIViewController <UITextFieldDelegate, VCConnectorIConnect, VCConnectorIRegisterLocalCameraEventListener, VCConnectorIRegisterLocalMicrophoneEventListener, VCConnectorIRegisterLocalSpeakerEventListener, VCConnectorIRegisterLogEventListener, VCConnectorIRegisterReconnectEventListener, VCConnectorIRegisterResourceManagerEventListener, VCConnectorIRegisterModerationCommandEventListener>
...
@property (weak, nonatomic) IBOutlet UISwitch *disableVideo;
@property (weak, nonatomic) IBOutlet UILabel *disableVideoLable;
